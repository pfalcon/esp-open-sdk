...
$(TOOLCHAIN)/bin/esptool.py: $(TOOLCHAIN)/bin/xtensa-lx106-elf-gcc
...
$(VENDOR_SDK_DIR_1.2.0)/.sdk_patch: $(VENDOR_SDK_DIR_1.2.0)/.sdk_unzip $(DWNLOAD)/lib_mem_optimize_150714.zip $(DWNLOAD)/libssl_patch_1.2.0-2.zip $(VENDOR_SDK_DIR)/.build/empty_user_rf_pre_init.o #$(DWNLOAD)/libssl_patch_1.2.0-2.zip
